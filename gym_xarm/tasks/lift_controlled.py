...
from gym_xarm.tasks.base_controlled import BaseControlled


class LiftControlled(BaseControlled):
    metadata = {
        **BaseControlled.metadata,
        "action_space": "joint_velocities_and_gripper",
        "episode_length": 50,
